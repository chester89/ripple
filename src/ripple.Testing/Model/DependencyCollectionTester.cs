...
namespace ripple.Testing.Model
{
    ...
    public class DependencyCollectionTester
    {
        ...
        [Test]
        public void validation_with_no_problems()
        {
            theSolutionDependencies.Add(new Dependency("Test"));
            theSolutionDependencies.Add(new Dependency("Test", "1.0.0.0", UpdateMode.Fixed));

            theSolutionDependencies.Validate().IsValid().ShouldBeTrue();
        }

        [Test]
        public void validation_with_problems()
        {
            theSolutionDependencies.Add(new Dependency("Test", "", UpdateMode.Fixed));
            theSolutionDependencies.Validate().IsValid().ShouldBeFalse();
        }
        ...
        [Test]
        public void assert_is_valid_with_no_errors()
        {
            theSolutionDependencies.Add(new Dependency("Test"));
            theSolutionDependencies.AssertIsValid();
        }
    }
